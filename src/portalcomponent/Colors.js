...
<div class="row">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-warning">Custom Text Color Utilities</h6>
            </div>
            <div class="card-body">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-warning">Custom Font Size Utilities</h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-warning">Custom Background Gradient Utilities
                </h6>
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-4">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-warning">Custom Grayscale Background Utilities
                </h6>
            </div>
            <div class="card-body">
